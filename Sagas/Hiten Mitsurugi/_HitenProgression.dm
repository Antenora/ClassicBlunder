...
#define HITEN_PASSIVES_TIER_2 list("SlayerMod"=1, "Godspeed"=1, "AttackSpeed"=2, "Pursuer"=1, "Flow" = 1, "Instinct" = 1)
#define HITEN_PASSIVES_TIER_3 list("Godspeed"=1, "TechniqueMastery"=2, "Flow" = 1, "Instinct" = 1)
#define HITEN_PASSIVES_TIER_4 list("SlayerMod"=1, "Godspeed"=1, "MovementMastery"=4, "FluidForm"=1, "FavoredPrey"="All")
#define HITEN_PASSIVES_TIER_5 list("SlayerMod"=1, "Godspeed"=1, "AttackSpeed"=3, "Pursuer"=1, "Deicide"=5, "EmptyFlashStep"=1, "EndlessNine"=0.1)
