#define HITEN_PASSIVES_TIER_1 list("SlayerMod"=1, "Godspeed"=1, "Flicker"=1, "Pursuer"=1, "FavoredPrey"="Human")
#define HITEN_PASSIVES_TIER_2 list("Godspeed"=1, "AttackSpeed"=2, "Pursuer"=1)
#define HITEN_PASSIVES_TIER_3 list("Godspeed"=1, "TechniqueMastery"=2)
#define HITEN_PASSIVES_TIER_4 list("SlayerMod"=1, "Godspeed"=1,  "FavoredPrey"="Human")
...
#define HITEN_PASSIVES_TIER_7 list("SlayerMod"=1, "Godspeed"=2, "AsuraStrike"=1)
