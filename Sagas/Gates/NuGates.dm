...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateTwo
	...
	passives = list( "Momentum"=1, "Instinct"=1)
	PUSpike = 20
	strAdd=0.1
	spdAdd=0.15
	endAdd=0.1
	adjust(mob/p)
		passives = list( "Momentum"=1, "Instinct"=1,"PUSpike" = 20)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateFour
	...
	passives = list( "Momentum"=1.5, "Instinct"=1,"PUSpike" = 20)
	PUSpike = 20
	strAdd=0.1
	spdAdd=0.25
	endAdd=0.1
	adjust(mob/p)
		passives = list( "Momentum"=1.5, "Instinct"=1,"PUSpike" = 10)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateSix
	...
	endAdd=0.1
	adjust(mob/p)
		passives = list( "Momentum"=1, "Instinct"=1, "PUSpike" = 20, "Deicide" = 5)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
