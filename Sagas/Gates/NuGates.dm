...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateTwo
	...
	endAdd=0.1
	adjust(mob/p)
		passives = list("BlurringStrikes"=0.1, "Momentum"=1, "Instinct"=1,"PUSpike" = 20)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateFour
	...
	endAdd=0.1
	adjust(mob/p)
		passives = list("BlurringStrikes"=0.15, "Momentum"=1.5, "Instinct"=1,"PUSpike" = 10)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
...
/obj/Skills/Buffs/SlotlessBuffs/Autonomous/GateSix
	...
	Slotless = TRUE
	BuffName = "Sixth Gate"
	passives = list("BlurringStrikes"=0.1, "Momentum"=1, "Instinct"=1)
	PUSpike = 20
	strAdd=0.1
	spdAdd=0.25
	endAdd=0.1
	adjust(mob/p)
		passives = list("BlurringStrikes"=0.1, "Momentum"=1, "Instinct"=1, "PUSpike" = 20, "Deicide" = 5)
	Trigger(mob/User, Override=FALSE)
		adjust(User)
		..()
