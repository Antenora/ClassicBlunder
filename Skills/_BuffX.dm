...
//General
		Mark_of_the_Slayer
			...
			ForMult=1.2
			RecovMult=1.2
			passives = list("SlayerMod" = 3.5, "FatigueImmune" = 1, "LifeSteal" = 20, "FavoredPrey" = "Depths", "Holymod" = 3, "MovementMastery" = 1, "TechniqueMastery" = 2.5, "BuffMastery" = 1,"Deicide"= 1.5 )
			ManaGlowSize=3
			ManaGlow="C03434"
