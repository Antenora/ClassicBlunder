obj/Skills/Buffs/NuStyle/UIHybridStyles// ~~ Angel-taught advanced forms ~~ not unlocked via combo or tier progression ~~//Stat line for these is mostly in line with Tier 3s, but has a little extra oomph
	Ultra_Instinct_Sword
		...
		SwordClass = "Medium"
		passives = list("HybridStyle" = "SwordStyle", "LikeWater" = 5, "Instinct" = 4, "SwordAscension" = 6, "Sword Master" = 1, "Flow" = 2.5, "Parry" = 2, "Deflection" = 2,\
                        "Godspeed" = 2,  "Fury" = 3, "Deicide" = 1,  "Momentum" = 1.5, "PUSpike" = 50)
	...
	Ultra_Instinct_Grappling
		...
		passives = list("HybridStyle" = "UnarmedStyle", "Instinct" = 4, "LikeWater" = 4, "Muscle Power" = 5, "Grippy" = 4, "Scoop" = 3, "CounterMaster" = 4,\
                       "Momentum" = 3,  "Flow" = 3, "Juggernaut" = 1, "Fury" = 2, "Deflection" = 2, "Reversal" = 1,\
	...
	Ultra_Instinct_Mystic
		...
		LockX=-32
		LockY=-32
		passives = list("HybridStyle" = "MysticStyle", "Instinct" = 4,  "LikeWater" = 4, "Amplify" = 3, "Familiar" = 3, "Harden" = 2, "Flow" = 3, "Godspeed" = 1.5,\
	...
	Ultra_Instinct_Martial
		...
		LockX=-32
		LockY=-32
		passives = list("HybridStyle" = "UnarmedStyle", "Instinct" = 5, "LikeWater" = 4, "Momentum" = 3, "Fa Jin" = 3, "Flow" = 3,  "Deflection" = 1.5, \
