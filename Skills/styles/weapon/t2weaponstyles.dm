/obj/Skills/Buffs/NuStyle/SwordStyle
	Santoryu
		...
		passives = list("Fury" = 2,  "SweepingStrike" = 1, "DoubleStrike" = 2, "TripleStrike" = 0.5,\
	...
	Gatotsu
		...
		passives = list("HybridStyle" = "UnarmedStyle", "Fury" = 2,  "SweepingStrike" = 1, "BladeFisting" = 1, \
				"Iaijutsu" = 2.5, "Musoken" = 1, "CriticalDamage"= 0.05, "Extend" = 1)
	...
	Berserk
		...
		passives = list( "Rage" = 1, "Half-Sword" = 2,  "Parry" = 2.5,"Disarm" = 2,\
	...
	Witch_Hunter
		...
		passives = list("FavoredPrey" = "Vampire", "SlayerMod" = 2 , "Shearing" = 6, "BladeFisting" = 1, "Secret Knives" = "Stake", \
						"Tossing" = 2, "Half-Sword" = 2,  "Extend" = 1)
		BladeFisting=1
		NeedsSword=0
		StyleOff=1.15
		StyleStr=1.3
	...
	Phalanx_Style
		...
		passives = list("Reversal" = 0.25, "Deflection" = 1, "Harden" = 1.5, "Parry" = 2, "Disarm" = 2, "BladeFisting" = 1,\
				  "Secret Knives" = "Atlatl", "Tossing" = 2)
