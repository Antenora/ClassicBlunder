/obj/Skills/Buffs/NuStyle/UnarmedStyle
	Gun_Cleric_Style
		...
		StyleSpd = 1.15
		StyleFor = 1.3
		passives = list("CriticalDamage" = 0.1, \
						"SpecialStrike" = 1, "Gun Kata" = 1)
	...
	Gun_Kata_Style
		...
		StyleSpd = 1.3
		StyleFor = 1.3
		passives = list("CriticalDamage" = 0.15, \
						"SpecialStrike" = 1, "Gun Kata" = 1)
		verb/Gun_Kata_Style()
			set hidden=1
			src.Trigger(usr)
	Equilibrium_Style
		...
		StyleSpd = 1.5
		StyleFor = 1.5
		passives = list("CriticalDamage" = 0.3, \
						"SpecialStrike" = 1, "Gun Kata" = 1)
	...
	Clockwork_Style
		...
		StyleSpd = 2
		StyleFor = 2
		passives = list("CriticalDamage" = 0.5, \
						"SpecialStrike" = 1, "Gun Kata" = 1)
