...
//
	...
	Omnimancer
		SignatureTechnique = 3
		passives = list("Deterioration" = 1, "Erosion" = 0.15,  "Amplify" = 3, "LikeWater" = 4)
		...
		proc/swap_stance(o)
			switch(o)
				if("blizzard")
					...
					passives = list("Familiar" = 2, "ThunderHerald" = 1, "CriticalChance" = 20, "CriticalDamage" = 0.2,  "Harden" = 2, \
		...
		proc/swap_stance(o)
			switch(o)
				if("betel")
					...
					ElementalOffense = "Fire"
					ElementalDefense = "Fire"
					passives = list( "Scorching" = 2, "Combustion" = 60,  "Heavy Strike" = "Inferno", "Fa Jin" = 2, "Instinct" = 4, "Momentum" = 4)
					Finisher = "/obj/Skills/Queue/Finisher/Sorblow"
				if("kaus")
					StyleActive = "Kaus"
					StyleStr = 1.25
					...
					ElementalOffense = "Wind"
					ElementalDefense = "Wind"
					passives = list(  "Shocking" = 3, "Flicker" = 4, "Flow" = 4, "Speed Force" = 1, "AttackSpeed" = 2, "Fury" = 4, "Skimming" = 2)
				...
				if("gulus")
					...
					passives = list("HellPower" = 0.25, "AbyssMod" = 5,  "HellRisen" = 0.5,    "Scorching" = 5, "Poisoning" = 5, "LikeWater" = 4)
