...
proc/RegisterHuntContent()
	...
	// tier 2
	LifeHuntAdd(/obj/Items/Material/MonsterPart/wolf_fang, LIFE_W_DAMAGE, "CriticalChance", "Crit Chance", 1, 1)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/ant_antennae, LIFE_W_UTILITY, "Steady", "Steady", 0.4, 0.4)
	// tier 3
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/harpy_talon, LIFE_W_STRONG, "Flow", "Flow", 0.6, 0.6)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/ninja_star, LIFE_W_DAMAGE, "Instinct", "Instinct", 0.6, 0.6)
	...
	// tier 4
	LifeHuntAdd(/obj/Items/Material/MonsterPart/wyvern_beak, LIFE_W_DAMAGE, "CriticalChance", "Crit Chance", 3, 3)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/naga_scale, LIFE_W_STRONG, "BlockChance", "Block Chance", 3, 3)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/red_eye, LIFE_W_DAMAGE, "KillerInstinct", "Killer Instinct", 0.04, 0.04)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/cyclops_horn, LIFE_W_DAMAGE, "SpiritFlow", "Spirit Flow", 0.6, 0.6)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/dragon_bone, LIFE_W_DAMAGE, "Brutalize", "Brutalize", 1, 1)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/dragon_essence, LIFE_W_COMMON)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/colossal_core, LIFE_W_STRONG, "ManaStats", "Mana Stats", 1, 1, 1)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/fire_dragon_claw, LIFE_W_DAMAGE, "SpiritSword", "Spirit Sword", 0.2, 0.2)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/white_dragon_claw, LIFE_W_DAMAGE, "SpiritHand", "Spirit Hand", 0.8, 0.8)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/poison_dragon_claw, LIFE_W_DAMAGE, "HybridStrike", "Hybrid Strike", 0.6, 0.6, 1)
	LifeHuntAdd(/obj/Items/Material/MonsterPart/water_dragon_claw, LIFE_W_DAMAGE, "BlurringStrikes", "Blurring Strikes", 0.6, 0.6)
	...
	LifeHuntAdd(/obj/Items/Material/MonsterPart/ashes_dragon_claw, LIFE_W_DAMAGE, "Zornhau", "Zornhau", 0.6, 0.6)
