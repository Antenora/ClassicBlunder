...
// - races
		...
		UNDERDOG_DIVISOR = 4
		CONQ_HAKI_RACES = list(HUMAN, DEMON, SAIYAN, NAMEKIAN, MAJIN, MAKYO, WILDER, GAJALAKA, CHANGELING)
...
// globals
		...
		NoSagaRaces = list(ELDRITCH, NOBODY, DEMON, WILDER, ELF, SAIYAN, ANGEL, MAKAIOSHIN)
