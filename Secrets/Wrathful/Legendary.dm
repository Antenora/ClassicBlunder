obj/Skills/Buffs/NuStyle/Legendary
	Legendary_Stance
		...
		StyleStr=1.3
		Enlarge = 1.25
		passives = list("GiantForm" = 1, "DoubleStrike" = 1, "Fa Jin" = 2, "Momentum" = 1, "HardStyle" = 1, "Juggernaut" = 1,\
	...
	Legacy_Of_The_Fabled_King
		...
		StyleStr=1.35
		Enlarge = 1.5
		passives = list("GiantForm" = 1, "DoubleStrike" = 2, "Fa Jin" = 2, "Momentum" = 2, "HardStyle" = 1, "Juggernaut" = 1,\
	...
	True_Fist_Of_The_Fabled_King
		...
		StyleStr=1.5
		Enlarge = 1.75
		passives = list("GiantForm" = 1, "DoubleStrike" = 3, "Fa Jin" = 2, "Momentum" = 3, "HardStyle"=1, "Juggernaut" = 1,\
	...
	Fist_Of_The_King_Of_Tomorrow //no god ki
		...
		passives = list("GiantForm" = 1, "DoubleStrike" = 3, "Fa Jin" = 2, "Momentum" = 3, "HardStyle"=1, "Juggernaut" = 1,\
						...
						"Harden" = 2, "Deflection" = 1,"Gum Gum" =1)
		adjust(mob/p)
			passives = list("GiantForm" = 1, "DoubleStrike" = 3, "Fa Jin" = 3, "Momentum" = 3, "HardStyle" = 1, "Juggernaut" = 1,\
