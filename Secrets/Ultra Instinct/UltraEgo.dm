...
/obj/Skills/Buffs/NuStyle/UltraEgoOmen
	Ultra_Instinct_Style
		...
		passives = list("Persistence" = 2, "HardStyle" = 1, "UnderDog" = 3,  "Godspeed" = 1,"PureDamage" = 4, "DemonicInfusion" = 1)
		StyleSpd = 1.5
		StyleOff = 1.5
		StyleStr = 1.5
		StyleForce = 1.5
	...
	Perfected_Ultra_Instinct_Style
		...
		passives = list("Persistence" = 2, "HardStyle" = 2,"UnderDog" = 6,  "Godspeed" = 1,"PureDamage" = 5, "DemonicInfusion" = 1, "PUSpike" = 25)
		StyleSpd = 1.6
		StyleStr = 1.55
		StyleOff = 1.6
		StyleFor = 1.55
