/obj/Skills/Buffs/NuStyle/MortalUI
	...
	Mortal_Instinct_Style
		...
		passives = list("Deflection" = 0.5, "SoftStyle" = 1, "CounterMaster" = 0.25,"UnarmedDamage"=2)
		StyleSpd = 1.05
		StyleOff = 1.1
		StyleDef = 1.1
	...
	Incomplete_Ultra_Instinct_Style
		...
		passives = list("Deflection" = 1, "SoftStyle" = 1, "CounterMaster" = 1,"UnarmedDamage"=3)
		StyleSpd=1.25
		StyleOff=1.15
		StyleDef=1.25
		IconLock='AuraMysticBig.dmi'
	...
	Ultra_Instinct_Style
		...
		passives = list("Deflection" = 1, "SoftStyle" = 1, "CounterMaster" = 2, "Godspeed" = 1,"UnarmedDamage"=4)
		StyleSpd = 1.5
		StyleOff = 1.5
		StyleDef = 1.5
		...
		adjust(mob/p)
			if(p.isRace(CELESTIAL))
				...
				StyleOff=1.75
				StyleDef=1.75
				passives = list("Deflection" = 1, "SoftStyle" = 1, "CounterMaster" = 1,"UnarmedDamage"=4)
	...
	Perfected_Ultra_Instinct_Style
		...
		passives = list("CounterMaster" = 3, "Godspeed" = 1, "PUSpike" = 25,"UnarmedDamage"=5, "SoftStyle" = 1,"Deflection" = 1)
		StyleSpd = 1.6
		StyleOff = 1.55
		StyleDef = 1.6
		IconLock='GentleDivine.dmi'
		...
		adjust(mob/p)
			if(p.isRace(CELESTIAL))
				...
				StyleOff = 2
				StyleDef = 2
				passives = list("Deflection" = 1, "SoftStyle" = 1, "CounterMaster" = 1,"UnarmedDamage"=5)
