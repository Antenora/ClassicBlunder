obj/Skills/Buffs/NuStyle/NobodyLegendary
	...
	Legacy_of_Ashes // T0/1. This is based on the Legendary styles from last wipe. Fire/Sword
		...
		passives = list( "Godspeed" = 1, "Momentum" = 1, "DoubleStrike" = 1, "Instinct" = 2, "Iaijutsu" = 2,\
	...
	Sunslammer
		...
		ElementalOffense="Fire"
		ElementalDefense="Fire"
		passives = list( "Godspeed" = 2, "Momentum" = 1, "DoubleStrike" = 2, "Instinct" = 3, "Flow" = 2, "Iaijutsu" = 2,\
	...
	Heir_of_Grief // TUPAC BACK
		...
		ElementalOffense="Fire"
		ElementalDefense="Fire"
		passives = list( "Godspeed" = 2, "Momentum" = 1, "DoubleStrike" = 3, "Instinct" = 4, "Flow" = 3, "Iaijutsu" = 2,\
	...
	Overture
		...
		ElementalOffense="Fire"
		ElementalDefense="Fire"
		passives = list( "Godspeed" = 3, "Momentum" = 2, "DoubleStrike" = 3, "TripleStrike" = 0.5, "Instinct" = 5, "Flow" = 4, "Iaijutsu" = 3,\
