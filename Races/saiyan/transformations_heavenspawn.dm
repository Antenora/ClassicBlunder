transformation
	saiyan
		heavenborn_super_saiyan
			...
			form_glow_y = -32
			unlock_potential = 45
			passives = list("CalmAnger"=1, "Instinct" = 1, "Flow" = 1, "Flicker" = 1, "Pursuer" = 2,  "PureDamage" = 1, "PureReduction" = -4,  "HolyMod" = 1,  "SaiyanPower1"=0.5)
			speedadd = 0.6
			enduranceadd = 0.6
			offenseadd = 0.6
			defenseadd = 0.6
			...
			mastery_boons(mob/user)
				...
				passives = list("CalmAnger"=1, "Instinct" = 1+(MasteryBoost/4), "Flow" = 1+(MasteryBoost/4), "Flicker" = 1+(MasteryBoost/4), "Pursuer" = 2,  "PureDamage" = 3+(MasteryBoost/2), "PureReduction" = -2+MasteryBoost,  "HolyMod" = 1+MasteryBoost,  "SaiyanPower1"=0.8)
				...
				if(mastery >= 100)
					passives = list("CalmAnger"=1, "Instinct" = 1+(MasteryBoost/2), "Flow" = 1+(MasteryBoost/2), "Flicker" = 1+(MasteryBoost/2), "Pursuer" = 2,  "PureDamage" = 3+(MasteryBoost/2), "PureReduction" = -2+MasteryBoost, "HolyMod" = 1+MasteryBoost,  "SaiyanPower1"=1.75)
