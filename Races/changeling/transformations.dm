transformation
	changeling
		second_form
			...
			force = 1.5
			strength = 1.5
			passives = list("PureDamage" = 1, "Instinct" = 1, "Flicker" = 1, "Godspeed" = 1, "PureReduction" = -3)
		...
		third_form
			...
			force = 1.5
			strength = 1.5
			passives = list("PureDamage" = 1, "Instinct" = 1, "Flicker" = 1, "Godspeed" = 1, "PureReduction" = -3,  "Juggernaut" = -1)
		...
		final_form
			...
			force = 1.5
			strength = 1.5
			passives = list("PureDamage" = 3, "Instinct" = 1, "Flicker" = 1, "Godspeed" = 1, "PureReduction" = -3,  "CriticalBlock" = -0.25, "BlockChance" = -25, "CriticalChance" = 0.25, "CriticalDamage" = 0.25)
		...
		fifth_form
			...
			force = 1.5
			strength = 1.5
			passives = list("PureDamage" = 3, "Instinct" = 2, "Flicker" = 1, "Godspeed" = 2, "PureReduction" = -3, "Juggernaut" = 1)
			pot_trans = 5
			BioArmorMax = -100
