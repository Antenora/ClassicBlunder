ascension
	makaioshin
		...
		one
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 0.25, "HolyMod" = 0.25, "SpiritPower" = 0.25, "HellRisen" = 0.25, "Incomplete" = -0.25,  "PureDamage"=1, "PureReduction"=1)
			anger = 0.15
			strength = 0.25
			endurance = 0.25
			speed = 0.25
		...
		two
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 0.75, "HolyMod" = 0.5, "SpiritPower" = 0.25, "HellRisen" = 0.25, "Incomplete" = -0.25,  "PureDamage"=1, "PureReduction"=1)
			strength = 0.25
			force = 0.5
			defense = 0.25
			offense = 0.25
		...
		three
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 1, "HolyMod" = 2, "SpiritPower" = 0.25, "TechniqueMastery" = 1, "Incomplete" = -0.25,  "PureDamage"=1, "PureReduction"=1)
			anger = 0.2
			strength = 0.25
			force = 0.25
			endurance = 0.5
		...
		four
			...
			passives = list("HellPower" = 0.25, "HolyMod" = 2, "AbyssMod" = 2, "KiControlMastery"=1, "Incomplete" = -0.25,  "PureDamage"=1, "PureReduction"=1)
			anger = 0.15
			strength = 0.25
			force = 0.25
			defense = 0.75
		...
		five
			...
			passives = list("HellPower" = 1, "EndlessAnger" = 1, "SpiritPower" = 0.25, "GodKi"=1,  "PureDamage"=1, "PureReduction"=1)
