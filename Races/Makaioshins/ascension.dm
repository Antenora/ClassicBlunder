ascension
	makaioshin
		...
		one
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 0.25, "HolyMod" = 0.25, "SpiritPower" = 0.25, "HellRisen" = 0.25, "Incomplete" = -0.25, "BlurringStrikes"=0.1, "HybridStrike"=0.5,"PureDamage"=1, "PureReduction"=1)
			anger = 0.15
			intimidation = 50
			strength = 0.25
			endurance = 0.25
		...
		two
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 0.75, "HolyMod" = 0.5, "SpiritPower" = 0.25, "HellRisen" = 0.25, "Incomplete" = -0.25, "BlurringStrikes"=0.1, "HybridStrike"=0.5,"PureDamage"=1, "PureReduction"=1)
			intimidation = 50
			strength = 0.25
			force = 0.5
			defense = 0.25
		...
		three
			...
			passives = list("HellPower" = 0.25, "AbyssMod" = 1, "HolyMod" = 2, "SpiritPower" = 0.25, "TechniqueMastery" = 1, "Incomplete" = -0.25, "BlurringStrikes"=0.1, "HybridStrike"=0.5,"PureDamage"=1, "PureReduction"=1)
			anger = 0.2
			intimidation = 100
			strength = 0.25
			force = 0.25
		...
		four
			...
			passives = list("HellPower" = 0.25, "HolyMod" = 2, "AbyssMod" = 2, "KiControlMastery"=1, "Incomplete" = -0.25, "BlurringStrikes"=0.1, "HybridStrike"=0.5,"PureDamage"=1, "PureReduction"=1)
			anger = 0.15
			intimidation = 250
			strength = 0.25
			force = 0.25
		...
		five
			...
			passives = list("HellPower" = 1, "EndlessAnger" = 1, "SpiritPower" = 0.25, "GodKi"=1, "BlurringStrikes"=0.1, "HybridStrike"=1,"PureDamage"=1, "PureReduction"=1)
			intimidation = 250
